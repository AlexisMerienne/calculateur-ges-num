    ...
    getters : {
        ...
        getConclusionData (state) {
            ...
            return "<h5 style='display: flex;justify-content: center;margin-bottom: 2em'><strong>-- Pour Conclure --</strong></h5>Aujourd'hui, en prenant en compte l'utilisation de vos appareils ainsi que leurs coûts carbones liés à la production, vous avez émis <strong style='color:#6887ff'>" + consototale.toString() + "</strong><br><br>" +
                ...
                "<h5 style='display: flex;justify-content: center;margin-bottom: 2em'><strong>-- Bilan sur <span style='color:#6887ff'>1</span> an --</strong></h5>Si votre utilisation du numérique est la même chaque jour de l'année, alors en une année vous aurez émis autant de CO2 qu'une voiture diesel parcourant <strong style='color:#6887ff'>"+consodistancediesel.toString()+"  km</strong>"+
                "<br>Vos émissions carbone représentent <strong style='color:#6887ff'>"+partgestot+"%</strong> de votre empreinte carbone sur une année. Cependant, si votre empreinte carbone répond à l'<a href='https://datagir.ademe.fr/blog/budget-empreinte-carbone-c-est-quoi/'>objectif</a> dicté par la COP21, alors vos émissions de carbone liées au numérique représentent <strong style='color:#6887ff'>"+partgestot2050+"%</strong>de cet objectif<br>"
        },
        getProgress (state) {
